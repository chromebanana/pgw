...
class Home extends React.Component {
	...
	<p className="ph2 pb2 lh-copy"><span className="b">The People’s General Woodhouse</span> is a collective of woodworkers and other traders working in Sussex. We believe in:</p>
	...
	<div className="tc cf">
	<ImageThumb url={kitchen1}/>
	<ImageThumb url={kitchen2}/>
	<ImageThumb url={kitchen3}/>
