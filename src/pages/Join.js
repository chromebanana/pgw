...
import eloise from '../images/eloise.jpg';
...
<div className="bb b--black-20 lh-copy ph2 pb3">
    ...
    <h2>How to Join</h2>
    <p>What to be involved? Send us an email at <a href="mailto:thepeoplesgeneralwoodhouse@gmail.com"><div className="flex flex-wrap justify-center"><span className="pl2 pl1-ns">thepeoplesgeneralwoodhouse</span><span className="" >@gmail.com</span></div> </a></p>
...
<div className="pv3">
    ...
    <MemberCard name="Eloise Saville" trades="Painting and Decorating, Hanging Shelves, General Handiwork" tool="Stanley Knife" img={eloise}/>
</div>
</div>
</div>
);
