...
const Footer = () => {
 ...
 <footer className="tc mv4 mh6-ns pt3 bt b--black-20">
	...
	<a className=" flex pr2 mr2-ns link black-90 dim items-center"  href="tel:+447543498864" title="phone the pgw">
		<div className="f4 pr1"><Emoji emoji="📞" desc="Phone Emoji"/> </div>
		<span className="pl2">07543 498 864</span>
	</a>
	</div>
	<div className="dib pv1">
	...
	<div className="dib pv1">
	<a className=" flex items-center link black-90 dim" href="https://www.instagram.com/thepgw/" title="Instagram @thepgw">
