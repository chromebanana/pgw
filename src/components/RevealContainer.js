...
render()
{
  ...
  return(
 <div className={this.state.open ? "mv3 pv3 ba b--black-10 bw2 br3 pointer" : "mv3 pv3 ba b--black-10 br3 pointer bg-animate hover-bg-black-10 "} onClick={this.handleClick}>
