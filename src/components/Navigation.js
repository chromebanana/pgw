...
export const Navigation = () => {
  return (
	...
	<a className="link black-90 f4-ns mb2 f6 flex pv0-ns pv0 dim" href="mailto:thepeoplesgeneralwoodhouse@gmail.com" title="email thepeoplesgeneralwoodhouse@gmail.com">
		<div className="f3-ns pr2-ns"> <Emoji className="pr6" emoji="✉️" desc="Envelope Emoji"/></div><div className="flex flex-wrap"><span className="pl2 pl1-ns">thepeoplesgeneralwoodhouse</span><span className="" >@gmail.com</span></div>	
	</a>
